...
<html>
  <head>
    ...
    <title>EPSUM SERVICE | www.Distribuidos2017.com</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>EP</b>S</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Epsum Service</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Elvis Josué Vélez Hidalgo</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      Proyecto de Sistemas Distribuidos 2017
                      <small>Docente: Vargas Hernán</small>
                    </p>
                  </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017-2020 <a href="www.incanatoit.com">SpondylusDEV</a>.</strong> All rights reserved.
      </footer>
